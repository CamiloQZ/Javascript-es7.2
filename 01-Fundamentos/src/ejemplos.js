...
/* Ejemplo 3️ Coerción (implícita) */

console.log("Hola " + 5);   // Hola 5
console.log("10" - 2);      // 8
...
/*Ejemplo  4️ Conversión explícita */
...
/* Ejemplo 8️ const vs let extra */

let contador = 0;
contador++;

const usuario = { edad: 17 };
usuario.edad++;
...
/*Ejemplo  10 Conversión explícita extra */
